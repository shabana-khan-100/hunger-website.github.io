...
<html>
<head>
  <title>FOOD CONSUMER REGISTRATION</title>
    ...
    if(isset($_POST['submit'])){
      ...
      if($emailcount > 0){
        ...
        if($password ===$cpassword){
            ...
            $insertquery = " insert into registration( username,orgname, email, address, mobile, password, cpassword, token, status) values('$username', '$orgname', '$email', '$address', '$mobile', '$pass','$cpass','$token', 'inactive') ";
            ...
            if($iquery){
                ...
                $body = "Hi, $username. Click here to activate your email account http://localhost/sip/activate.php?token=$token ";
      ...
      <!--  <p> 
       ...
       <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
        ...
        <div class="form-group input-group">
         ...
         <input  name="orgname" class="form-control" placeholder="Organisation name" type="text" required>
       </div>
